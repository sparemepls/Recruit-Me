      ...
      <nav className="bg-base-100/80 backdrop-blur-md border-b border-primary/20 sticky top-0 z-50 shadow-lg">
        <div className="max-w-7xl mx-auto p-4 flex items-center justify-between">
          ...
          <SignInButton mode="modal">
            ...
            duration-200 hover:scale-105 flex items-center gap-2 cursor-pointer
            "
            >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-xl text-base-content/70 leading-relaxed max-w-xl">
              The ultimate platform for colaborative coding interviews and pair
              programing. connect face-to-face, code in real-time, and ace your
      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-base-content/70 max-w-2xl mx-auto">
            Powerful feature designed to make your coding interviews seamless
            and productive
          </p>
        </div>
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body items-center text-center">
              ...
              <p className="text-base-content/70">
                Crystal Clear video and audio for seamless communication between
                the interviews
              </p>
            </div>
          </div>
          ...
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body items-center text-center">
              ...
              <p className="text-base-content/70">
               Share your Screen,discuss solution , and learn from each other in real-time
              </p>
            </div>
          </div>
        </div>
